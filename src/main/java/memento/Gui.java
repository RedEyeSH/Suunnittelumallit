...
public class Gui extends Application {
    ...
    public void start(Stage stage) {
        ...
        Label redoLabel = new Label("Press Ctrl-Y to redo the last undone change.");
        redoLabel.setPadding(insets);

        Button showHistoryButton = new Button("Show History");
        showHistoryButton.setPadding(insets);
        showHistoryButton.setOnAction(event -> showHistory());

        // create a VBox that contains the HBox and the CheckBox
        VBox vBox = new VBox(hBox, checkBox, undoLabel, redoLabel, showHistoryButton);
